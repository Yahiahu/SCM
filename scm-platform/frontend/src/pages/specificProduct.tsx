      ...
      try {
        ...
        const lowStockItems = warehouseInventory.filter(
          (item: BackendWarehouseInventory) =>
            item.current_qty < (item.component?.min_stock_level ?? Infinity)
        ).length;
        ...
        setMetrics([
          ...
          },
          {
            ...
            changeColor: lowStockItems > 0 ? "orange.400" : "blue.500",
          ...
          },
          {
            ...
            changeColor: outOfStockItems > 0 ? "orange.400" : "blue.500",
          ...
          <Box p={6} pt={20}>
            ...
            >
              ...
              <Box display="flex" alignItems="center" gap={2}>
                <Search size={18} />
                <Text fontWeight="medium">Search Inventory</Text>
                <input
                  type="text"
                      ...
                      <Flex gap={6} fontSize="sm">
                        ...
                        <Flex align="center">
                          <Box
                            ...
                            mr={2}
                          />
                          <Text color="gray.600">Utilization</Text>
                        </Flex>
                      </Flex>
                    </Flex>
